...
const COPY = {
  pl: {
    hero: 'Zostan\nprzyjacielem\nFilleo',
    sub: 'Subskrybuj',
    text: 'Dolacz do grona przyjaciol Filleo i otrzymuj inspiracje oraz oferty specjalne.',
    sentTitle: 'Zostan przyjacielem Filleo',
    sentText: 'Dziekujemy za dolaczenie! Wkrotce odezwiemy sie z nowosciami.',
    ...
    zip: 'Kod pocztowy*',
    country: 'Kraj*',
    region: 'Stan/wojewodztwo/terytorium (poza USA)',
    consent: 'Chce otrzymywac wiadomosci e-mail od Filleo. Zgadzam sie na informacje marketingowe i akceptuje zasady przetwarzania danych w ',
    privacy: 'Polityce prywatnosci',
    send: 'Wyslij',
    sending: 'Wysylanie...',
    pFirst: 'Wprowadz swoje imie',
    pLast: 'Wprowadz swoje nazwisko',
    pEmail: 'Wprowadz swoj adres e-mail',
    pZip: 'Wprowadz swoj kod pocztowy',
    pRegion: 'Wprowadz swoj region',
    eFirst: 'Podaj imie',
    eLast: 'Podaj nazwisko',
    eEmail: 'Podaj poprawny e-mail',
    eBirth: 'Podaj prawidlowa date (DD/MM/RRRR)',
    eBirthInvalid: 'Nieprawidlowa data',

...
const COPY = {
  pl: {
    ...
    giftsText: 'Tworzymy wyjątkowe zestawy prezentowe dopasowane do okazji, marki i odbiorcy.',
    contact: 'Skontaktuj się z nami',
    ctaTitle: 'Chcesz stworzyć swój zestaw?',
  },
  en: {
    ...
    ctaTitle: 'Want to create your own set?',
  },
  it: {
    ...
    ctaTitle: 'Vuoi creare il tuo set?',
  },
} as const;
    ...
    <main className="bg-brand-light text-brand-dark">
      <section className="relative">
        <div className="absolute inset-0 z-0">
          <Image src="/images/Filleo%20strona.png" alt="Inspirations banner" fill priority sizes="100vw" className="object-cover" />
        </div>
          ...
          <div className="rounded-2xl bg-white p-5 shadow-xl ring-1 ring-black/5 md:p-8 lg:p-10">
            ...
            <div className="mt-8 flex justify-center">
              <div className="text-center">
                <p className="mb-3 text-lg font-medium text-brand-dark">{t.ctaTitle}</p>
                <Link href="/kontakt" className="inline-flex items-center rounded-md bg-brand-red px-6 py-3 text-sm font-bold uppercase tracking-wide text-brand-light shadow transition hover:bg-brand-dark focus:outline-none focus:ring-2 focus:ring-brand-beige">
                  {t.contact}
                </Link>
              </div>
            </div>
